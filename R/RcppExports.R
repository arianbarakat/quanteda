...
test_arma <- function(x) {
    .Call(`_quanteda_test_arma`, x)
}

test_arma2 <- function(x) {
    .Call(`_quanteda_test_arma2`, x)
}

test_arma3 <- function(x) {
    invisible(.Call(`_quanteda_test_arma3`, x))
}

test_arma4 <- function(x) {
    invisible(.Call(`_quanteda_test_arma4`, x))
}

test_arma5 <- function(x) {
    invisible(.Call(`_quanteda_test_arma5`, x))
}

test_arma10 <- function(x) {
    invisible(.Call(`_quanteda_test_arma10`, x))
}

test_std <- function(x) {
    .Call(`_quanteda_test_std`, x)
}
